          ...
          {skills.map((row, index) => {
            return (
              <motion.div
                ...
                key={index + row.name}
                className="m-1 rounded-full bg-gradient-to-t from-gray-950 from-50% to-gray-900 ring-1 ring-inset ring-white/10 inline-grid grid-cols-[1rem,1fr] items-center gap-2 whitespace-nowrap px-3"
              >
